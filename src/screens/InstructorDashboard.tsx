      ...
      <div className="absolute inset-0 overflow-y-auto pb-12 scrollbar-none">
        ...
        <section className="mt-7 px-5">
          <div className="flex items-baseline justify-between">
            ...
            <button className="press-soft inline-flex items-center gap-1 rounded-full bg-sand px-3 py-1.5 text-[12px] font-medium">
              <Plus size={14} /> New
            </button>
          </div>
        ...
        <section className="mt-7 px-5">
          ...
          <div className="mt-3 grid grid-cols-2 gap-3">
            <ActionCard icon={Calendar} title="Edit schedule" body="Add a class, block a date." />
            <ActionCard icon={Users} title="Roster" body="See who’s booked today." />
            <ActionCard icon={TrendingUp} title="Earnings" body="Statements & payouts." />
            <ActionCard icon={Sparkles} title="Profile" body="Bio, photos, certs." />
          </div>
        </section>
        ...
        <section className="mt-7 mx-5 rounded-[20px] bg-sand p-5">
          <div className="flex items-center justify-between">
            ...
            <Button size="sm" variant="tertiary">Finish</Button>
          </div>
...
function ActionCard({ icon: Icon, title, body }: { icon: typeof Calendar; title: string; body: string }) {
  return (
    <button className="press-soft flex flex-col items-start gap-2 rounded-2xl border border-stone bg-bone p-4 text-start">
